<template>
  <div style="max-width: 600px; margin: 0 auto">
    <el-button type="text" :icon="ArrowLeft" @click="router.push('/')" style="margin-bottom: 16px">
      返回
    </el-button>
    ...
    <el-card v-loading="loading">
      ...
      >
        <el-form-item prop="username" label="昵称">
          <el-input v-model="formData.username" placeholder="请输入昵称" />
        </el-form-item>

        <el-form-item prop="bio" label="个人介绍">
          <el-input
